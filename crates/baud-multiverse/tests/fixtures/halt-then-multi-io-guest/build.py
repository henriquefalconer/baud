...
# ../halt-then-spin-guest/build.py (this fixture's direct template) -- only payload.s's actual
# instructions differ (three separate `out` writes after waking, instead of one before spinning).
