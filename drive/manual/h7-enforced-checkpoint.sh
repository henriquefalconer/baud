...
# drive/manual/h7-enforced-checkpoint.sh — H7's double_boot_ram_hash_identical leg (todo.md §14
...
#
# Sibling of drive/manual/h7-enforced-entropy.sh, same unconditional-restore discipline: this is the
...
# cause turned out to be the same bug behind drive/manual/h7-enforced-entropy.sh's flakiness:
