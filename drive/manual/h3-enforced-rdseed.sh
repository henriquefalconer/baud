...
# drive/manual/h3-enforced-rdseed.sh — first real, on-hardware boot of the enforced-regime's RDSEED
# enforcement (todo.md §4/§3.8's "custom KVM module", kernel-module/baud-enforced/
# ENFORCEMENT_DESIGN.md and ud2-enforce.patch).
#
# Sibling of drive/manual/h3-enforced-rdtsc.sh and drive/manual/h3-enforced-rdrand.sh, same unconditional-restore
