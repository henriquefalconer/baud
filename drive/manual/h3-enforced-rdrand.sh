...
# drive/manual/h3-enforced-rdrand.sh — first real, on-hardware boot of the enforced-regime's RDRAND
...
echo ""
echo "Covered by a sibling script, not this one: RDSEED enforcement (drive/manual/h3-enforced-rdseed.sh,"
