...
echo ""
echo "Not yet done: RDSEED enforcement (SECONDARY_EXEC_RDSEED_EXITING is not settable on this"
echo "host's VMX microcode per baud_enforced_probe's own dmesg report — a hardware limitation,"
echo "not a design gap)."
