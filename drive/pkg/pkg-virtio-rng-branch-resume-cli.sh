...
# drive/pkg/pkg-virtio-rng-branch-resume-cli.sh — proves the last-open half of todo.md §14's
...
# path already did (drive/pkg/pkg-virtio-rng-replay-cli.sh).
#
...
SNAP_ROOT="$(mktemp -d -t baud-pkg-rng-br-snap-XXXXXX)"
