...
# drive/m12.sh — M12 drive script: a branch-originated run also gets a kvm_run_meta row, end to
...
# /run/kvm output from drive/m11.sh).
#
...
#         pixels (10,10,10),(20,20,20),(30,30,30),(40,40,40) — the same real pixels drive/m11.sh's
